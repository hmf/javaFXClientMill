...
object hansolo extends ScalaModule {
  ...
  object charts extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.ChartTest")
  ...
  object arc extends OpenJFX with ScalaModule {
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.ArcChartTest")
  ...
  object bar extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.BarChartTest")
  ...
  object box extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.BoxPlotTest")
  ...
  object bubble extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
  ...
  object graph extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.ForceDirectedGraphTest")
  ...
  object grid extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.GridTest")
  ...
  object timeSeries extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.MultiTimeSeriesTest")
  ...
  object voronoi extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.VoronoiChartTest")
  ...
  object maps extends OpenJFX with ScalaModule {
    def scalaVersion = T{ ScalaVersion }
    ...
    override def mainClass: T[Option[String]] = Some("hansolo.charts.WaferMapTest")
